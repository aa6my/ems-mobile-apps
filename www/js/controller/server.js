...
var apps_server = angular.module('serverModule', []);
  ...
  $ionicSideMenuDelegate.canDragContent(false);
    ...
    var murl = 'https://segiapps.com/x/dataAll/type/company/key/ems-product_id/val/1-2/joinid/company_id/jointo/applications';
    ...
    $scope.goToLogin = function(){
      if ($scope.company_id == null) {
        ...
        url = 'https://segiapps.com/x/dataAll/type/company/key/ems-product_id-company.company_id/val/1-2-'+$scope.company_id+'/joinid/company_id/jointo/applications';
